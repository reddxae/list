...
* [SOVA V RE.](https://t.me/sovaV) *Почти* актуальный клиент с *почти* всеми функциями старых версий на основе свежей базы.

### 💬 Мессенджеры
Telegram:
* [Cherrygram.](https://github.com/arsLan4k1390/Cherrygram) Ключевые функции: поддерживает CameraX для видеосообщений (позволяет записывать в качестве, близком к iOS-версии), центрирование заголовка в шапке приложения и другие функции, что есть в большинстве клиентов. Поставляется с открытым исходным кодом, что является бесспорным преимуществом. На всех моих устройствах подлагивает, поэтому (и не только) я отдаю предпочтение клиенту ниже.
* [exteraGram.](https://t.me/exteraGramCI) Клиент с очень красивым интерфейсом и грамотной Monet-покраской. По функционалу, есть отключение Premium-анимаций/стикеров/оформления профиля, оформления сообщений, статусов, аватаров и т.п., скрытие нижней панели в каналах, скрытие меню "Отправить от имени канала" с сохранением его функцилнальности, сворачивание клавиатуры при прокрутке чата, бесконечные недавние стикеры, новое сжатие отправляемых фото (2560px) и некоторые другие эксклюзивные функции, такие как AI Chat, адблок для встроенного браузера, использование Яндекс Карт для вместо Google и другое. Этот клиент, впрочем, как и многие другие, не обновляет свой исходный код.
* [Plus Messenger.](https://t.me/PlusMessengerUpdates) Идейный собрат ныне покойного [BGram.](https://t.me/BGramChannel) Огромное количество функций и надежная поддержка.
...
Discord:
* [Bunny для Discord.](https://github.com/bunny-mod/Bunny)
...
* 🪦 [Kiwi Browser.](https://github.com/kiwibrowser/src.next/releases/tag/12867802748) Поддерживает [десктопные расширения](https://github.com/reddxae/list/blob/main/list/browser_add-ons.md) для Chrome и ещё [несколько полезных функций.](https://kiwibrowser.com/features/) 
...
* [Weather Master.](https://github.com/PranshulGG/WeatherMaster) Закос под реализацию от Google, содержащий микс дизайна страницы погоды из приложения Google Поиска и отдельного приложения Погоды (того, что указано выше). Работает всё еще так себе, потому на любителя.
...
* <sup>`(Модуль / Android 13+)`</sup> [BetterQS.](https://github.com/reddxae/list/blob/magisk-modules/better_qs.zip) Удобная разметка панели быстрого доступа при горизонтальной ориентации экрана.<sup>[`ℹ️`](https://github.com/reddxae/list/blob/magisk-modules/betterqs_preview.png)</sup>
...
### 🛜 Сеть
* [AFWall+.](https://github.com/ukanth/afwall) Фаервол для Android, работающий с использованием root-прав. По сути, это продвинутый GUI для iptables. [Варез здесь.](https://4pda.to/forum/index.php?showtopic=392249)
...
* [Disable logging.](https://github.com/reddxae/list/tree/magisk-modules#disable-logging) Отключение логгирования.
