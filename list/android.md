...
* <sup>`(Root, Android 12+)`</sup> [Global Icon Pack.](https://github.com/RichardLuo0/global-icon-pack-android) Применение пакетов иконок для всей системы и/или для лаунчеров, где этот функционал не предусмотрен. 
