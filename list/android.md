...
### 💬 Мессенджеры
Telegram:
* [Nekogram.](https://t.me/NekoUpdates) Клиент с набором классических функций и открытым исходным кодом. Недавно (в кои-то веки!) добавили опцию, отключающую воспроизведение медиа на экране по нажатию клавиш громкости.
* [exteraGram.](https://t.me/exteraGramCI) Клиент с очень красивым интерфейсом и грамотной Monet-покраской. По функционалу, есть отключение Premium-анимаций/стикеров/оформления профиля, оформления сообщений, статусов, аватаров и т.п., скрытие нижней панели в каналах, скрытие меню "Отправить от имени канала" (с сохранением его функциональности), сворачивание клавиатуры при прокрутке чата, бесконечные недавние стикеры, новое сжатие отправляемых фото (2560px), отключение воспроизведения медиа на экране по нажатию клавиш громкости и некоторые другие эксклюзивные функции, такие как AI Chat, адблок для встроенного браузера, использование Яндекс Карт для вместо Google и другое. Этот клиент, впрочем, как и многие другие, не обновляет свой исходный код.
...
* [Nagram.](https://t.me/nagram_channel) Клиент Telegram, совмещающий в себе функционал обычного [Nekogram](https://github.com/reddxae/list/blob/main/list/android.md#:~:text=Nekogram) и одноимённой [X-версии.](https://t.me/NekogramX)
...
Discord:
* [Bunny для Discord.](https://github.com/bunny-mod/Bunny) Приложение запускается заметно дольше оригинального клиента.
